<template>
  <v-app>
    ...
    <v-app-bar elevation="1">
      ...
      <v-toolbar-title>餐厅管理系统</v-toolbar-title>
    </v-app-bar>
...
const navItems = [
  { title: '餐桌概览', icon: 'mdi-table-chair', to: '/tables' },
  ...
  { title: '用餐区域', icon: 'mdi-map-marker-multiple', to: '/areas' },
  { title: '传菜员管理', icon: 'mdi-account-group', to: '/waiters' },
  { title: '传菜任务', icon: 'mdi-food-takeout-box', to: '/delivery-tasks' },
