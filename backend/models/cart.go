...
type CartSession struct {
	...
	Table *Table        `gorm:"foreignKey:TableID;references:TableID" json:"table,omitempty"`
	Items []SessionItem `gorm:"foreignKey:SessionID;references:SessionID" json:"items,omitempty"`
}
